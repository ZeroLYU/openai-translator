...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--config', type=str, default='config.yaml', help='Configuration file with model '
                                                                                    'and API settings.')
        self.parser.add_argument('--model_type', type=str, choices=['GLMModel', 'OpenAIModel'],
    ...
    def parse_arguments(self):
        ...
        if args.model_type == 'GLMModel' and not args.glm_model_url:
            self.parser.error("--glm_model_url is required when using GLMModel")
        return args
